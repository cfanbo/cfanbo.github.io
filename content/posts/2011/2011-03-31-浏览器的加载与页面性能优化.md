...
关于编码识别，Mozilla开源了其中的[Mozilla Charset Detectors][30]模块，感兴趣的可以对其进行学习
...
另外，可以使用[ADsafe][41]等方案来保证嵌入第三方广告的安全，请参考[如何安全地嵌入第三方js – FBML/caja/sandbox/ADsafe简介][42]
...
另外就是通过静态图片来衡量带宽和网络延迟，具体可以看[boomerang][52]
