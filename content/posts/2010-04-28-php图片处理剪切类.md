...
author: admin
type: post
date: 2010-04-28T07:45:42+00:00
url: /archives/3503
IM_contentdowned:
 - 1
categories:
...
var$mask_pos_x = ;// 水印横坐标

var$mask_pos_y = ;// 水印纵坐标
...
functionsetMaskPosition($position=)
...
imagefilledrectangle($this->h_dst,,,$this->dst_w,$this->dst_h,$white);// 填充背景色
...
$color = ImageColorAllocate($this->h_src,$c[],$c[1], $c[2]);

imagefilledrectangle($this->h_dst,,,$this->dst_w,$this->dst_h,$color);// 填充背景色
...
$color = imagecolorallocatealpha($src, $c[], $c[1],$c[2], $this->mask_txt_pct);
...
$arr = imagettfbbox($this->font_size,, $this->font,$this->mask_word);

$this->mask_w = abs($arr[] – $arr[2]);
...
function_setNewImgSize($img_w, $img_h=null)
...
imagecopy($new_im, $src, , $src_y – $y – 1, , $y,$src_x, 1);
...
imagecopy($new_im, $src, $src_x – $x – 1, , $x, ,1, $src_y);
