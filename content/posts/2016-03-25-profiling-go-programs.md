...
author: admin
type: post
date: 2016-03-25T01:16:22+00:00
url: /archives/16860
categories:
 - 程序开发
tags:
...
---
转自： [http://blog.golang.org/profiling-go-programs](http://blog.golang.org/profiling-go-programs) （需翻墙)

# [The Go Blog][1]

### [Profiling Go Programs][2] {.title}
...
[![profiling-go-programs_havlak1a-75](http://blog.haohtml.com/wp-content/uploads/2016/03/profiling-go-programs_havlak1a-75.png)](http://blog.haohtml.com/wp-content/uploads/2016/03/profiling-go-programs_havlak1a-75.png)
...
[![profiling-go-programs_havlak1-hash_lookup-75](http://blog.haohtml.com/wp-content/uploads/2016/03/profiling-go-programs_havlak1-hash_lookup-75.png)](http://blog.haohtml.com/wp-content/uploads/2016/03/profiling-go-programs_havlak1-hash_lookup-75.png)
...
[![profiling-go-programs_havlak4a-mallocgc](http://blog.haohtml.com/wp-content/uploads/2016/03/profiling-go-programs_havlak4a-mallocgc.png)](http://blog.haohtml.com/wp-content/uploads/2016/03/profiling-go-programs_havlak4a-mallocgc.png)
...
[![profiling-go-programs_havlak4a-mallocgc-trim](http://blog.haohtml.com/wp-content/uploads/2016/03/profiling-go-programs_havlak4a-mallocgc-trim.png)](http://blog.haohtml.com/wp-content/uploads/2016/03/profiling-go-programs_havlak4a-mallocgc-trim.png)
 ...
 * [Generating code][3]
 * [Introducing the Go Race Detector][4]
 * [Go maps in action][5]
 * [go fmt your code][6]
 * [Organizing Go code][7]
 * [Debugging Go programs with the GNU Debugger][8]
 * [The Go image/draw package][9]
 * [The Go image package][10]
 * [The Laws of Reflection][11]
 * [Error handling and Go][12]
 * [“First Class Functions in Go”][13]
 * [A GIF decoder: an exercise in Go interfaces][14]
 * [Introducing Gofix][15]
 * [Godoc: documenting Go code][16]
 * [Gobs of data][17]
 * [C? Go? Cgo!][18]
 * [JSON and Go][19]
 * [Go Slices: usage and internals][20]
 * [Go Concurrency Patterns: Timing out, moving on][21]
 * [Defer, Panic, and Recover][22]
 * [Share Memory By Communicating][23]
 * [JSON-RPC: a tale of interfaces][24]

 [1]: http://blog.golang.org/
 [2]: http://blog.golang.org/profiling-go-programs
 [3]: http://blog.golang.org/generate
 [4]: http://blog.golang.org/race-detector
 [5]: http://blog.golang.org/go-maps-in-action
 [6]: http://blog.golang.org/go-fmt-your-code
 [7]: http://blog.golang.org/organizing-go-code
 [8]: http://blog.golang.org/debugging-go-programs-with-gnu-debugger
 [9]: http://blog.golang.org/go-imagedraw-package
 [10]: http://blog.golang.org/go-image-package
 [11]: http://blog.golang.org/laws-of-reflection
 [12]: http://blog.golang.org/error-handling-and-go
 [13]: http://blog.golang.org/first-class-functions-in-go-and-new-go
 [14]: http://blog.golang.org/gif-decoder-exercise-in-go-interfaces
 [15]: http://blog.golang.org/introducing-gofix
 [16]: http://blog.golang.org/godoc-documenting-go-code
 [17]: http://blog.golang.org/gobs-of-data
 [18]: http://blog.golang.org/c-go-cgo
 [19]: http://blog.golang.org/json-and-go
 [20]: http://blog.golang.org/go-slices-usage-and-internals
 [21]: http://blog.golang.org/go-concurrency-patterns-timing-out-and
 [22]: http://blog.golang.org/defer-panic-and-recover
 [23]: http://blog.golang.org/share-memory-by-communicating
 [24]: http://blog.golang.org/json-rpc-tale-of-interfaces