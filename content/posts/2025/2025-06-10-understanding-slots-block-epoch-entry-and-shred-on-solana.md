...
对于刚刚接触Solana的开发者来讲，会经常遇到 Slot Block Epochs Entry 和 Shred等一些概念术语，但不太容易记住它们，本篇将通过Solana的交易原理让大家轻松记信这些术语的作用和它们之间的联系，以此对Solana交易有更深入的理解。由于能力有限，文章中如果有清楚的地方，可以在文章下方进行评价，共同学习进步！

好了，现在让我们彻底搞明白这些术语在Solana交易中的作用吧！在开始之前我们先看一下在Soalna链中一笔交易是如何进行的。
